---
name: code-complete
description: 'Full Code Complete rules for disciplined construction, defensive coding, and implementation quality. Use when building features, refining control flow, hardening logic, reviewing implementation choices.'
argument-hint: 'Describe the task, target files, and the implementation or construction concern you want addressed.'
user-invocable: true
---
...
3. Test complex data-driven logic with representative tables and edge cases.
4. Test that refactoring preserves behavior.
