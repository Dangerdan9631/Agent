...
description: 'Full DDIA rules for reliability, consistency, data flow, and schema evolution. Use when designing storage, modeling events, handling replication, reviewing distributed tradeoffs.'
argument-hint: 'Describe the task, target files, and the data, consistency, or systems concern you want addressed.'
user-invocable: true
---
