...
description: 'Full Domain-Driven Design rules for bounded contexts, ubiquitous language, and model integrity. Use when modeling domains, defining aggregates, splitting contexts, reviewing business concepts.'
argument-hint: 'Describe the task, target files, and the domain-modeling or context-mapping concern you want addressed.'
user-invocable: true
---
