---
name: release-it
description: 'Full Release It! rules for resilience, backpressure, and production safety. Use when hardening services, handling failures, adding observability, reviewing operational risk.'
argument-hint: 'Describe the task, target files, and the reliability, resilience, or production concern you want addressed.'
user-invocable: true
---
