...
description: 'Full Pragmatic Programmer rules for responsibility, automation, and practical engineering judgment. Use when reducing duplication, automating work, clarifying ownership, improving feedback loops.'
argument-hint: 'Describe the task, target files, and the pragmatic engineering outcome you want.'
user-invocable: true
---
