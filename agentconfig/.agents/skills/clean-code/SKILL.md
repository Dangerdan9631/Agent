---
name: clean-code
description: 'Full Clean Code rules for readability, naming, small functions, and maintainable implementation. Use when cleaning code, improving names, tightening functions, reviewing clarity.'
argument-hint: 'Describe the task, target files, and the code quality outcome you want.'
user-invocable: true
---
