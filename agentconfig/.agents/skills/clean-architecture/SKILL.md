...
description: 'Full Clean Architecture rules for boundaries, policy-detail separation, and dependency direction. Use when restructuring layers, isolating frameworks, protecting domain logic, reviewing architecture.'
argument-hint: 'Describe the task, target files, and the architecture or boundary concern you want addressed.'
user-invocable: true
---
