...
This directory contains local HTTP adapters for architecture artifact workflows. It serves generated diagram files and owns the write boundary for checked-in layout artifacts, diagram-driven root config updates, and replaceable image exports.
