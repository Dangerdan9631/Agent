...
Each bundled agent declares MCP config targets and merge rules in its extension manifest. Generators keep agent setup idempotent across repeated toolkit operations.
