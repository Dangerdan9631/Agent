...
export interface WorkflowDefinition {
  ...
  /**
   * Versioned manifesto declarations addressable by workflow and step references.
   */
  readonly manifestoDefinitions?: readonly ManifestoDefinition[];

  /**
   * Ordered global manifestos loaded before every step.
   */
