...
import type { ManifestoProvenance } from '#api/contracts/workflow/manifesto-resolution.js';
...
export interface WorkflowRunStateV1 {
  ...
  /**
   * Ordered manifesto resolution provenance for the current step attempt.
   */
  readonly manifestoProvenance?: readonly ManifestoProvenance[];
}
