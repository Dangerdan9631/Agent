...
This directory contains versioned, transport-neutral contracts for workflow hook
execution and the minimal workflow run snapshot visible at hook boundaries.
