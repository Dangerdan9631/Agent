...
/// <summary>
/// Reads C# project paths from supported solutions through the CLI's MSBuild workspace.
/// </summary>
public sealed class SolutionProjectDiscoverer : ISolutionProjectDiscoverer
{
    /// <summary>
