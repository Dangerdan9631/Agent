...
public sealed class CSharpModuleExtractor
{
    ...
    /// <summary>
    /// Loads and extracts one target-specific SDK project.
    /// </summary>
    ...
    public async Task<ExtractedModule> ExtractAsync(CSharpProjectTarget target)
    {
        ...
        var documents = physical.Concat(generated).ToArray();
