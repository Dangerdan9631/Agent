...
{
    private readonly SolutionProjectDiscoverer solutionDiscoverer;
    private readonly CSharpProjectEvaluator evaluator;
    ...
    public CSharpWorkspaceDiscoverer(
        SolutionProjectDiscoverer solutionDiscoverer,
        CSharpProjectEvaluator evaluator,
