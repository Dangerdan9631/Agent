...
"""
        ...
        this.write(
            fixture,
            "one/build/generated/ksp/main/resources/atlas/jvm.atlas.fragment.yml",
            """{
...
"""
        ...
        GradleRunner.create()
            ...
            .withPluginClasspath()
            .build()
        val manifest = Files.readString(fixture.resolve("build/atlas/models/atlas.manifest.yml"))
        assertContains(manifest, "example:one:1.2.3")
        assertContains(manifest, "example:two:1.2.3")
        val firstModel = fixture.resolve("build/atlas/models/one/one.atlas.module.yml")
        assertTrue(Files.exists(firstModel))
        assertTrue(Files.exists(fixture.resolve("build/atlas/models/two/two.atlas.module.yml")))
